...
public class Application {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    directStream.mapToPair(record -> {
          ...
          Output o = new Output(1L, (long) purchase.getNumber(), record.timestamp(),record.timestamp(), l, l);
          ...
          rdd.foreachPartition(p -> {
            while (p.hasNext()) {
              ...
              String valueAsString =
                  ObjectMapperFactory.getObjectMapper().writeValueAsString(message);
              ProducerRecord<Object, String> record =
                  new ProducerRecord<>(KafkaConfig.TOPIC_OUTPUT, product, valueAsString);
